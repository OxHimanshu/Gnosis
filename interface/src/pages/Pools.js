...
function Pools() {
    ...
    const chainObj = {
        ...
        10_200: {
            chainId: 10_200,
            chianName: "Gnosis Chiado Testnet",
            explorer: "https://blockscout.chiadochain.net/tx/",
            rpc: "https://rpc.chiadochain.net",
            zeroX: "https://mumbai.api.0x.org/",
            receiverContract: "0x2A464711409Fc8487Ab8a764F453368AFbc0DAD3",
            hashiPoolContract: "0x93c3F8F780ADE43b98467177FaDe0d38Ebd03787",
            domain: 10145,
            tokens: [
                {
                    token: "USDT",
                    address: "0xD4441eCbC073970c86a6C121c47f371D1d109ceA",
                    decimals: 18
                },
                {
                    token: "USDC",
                    address: "0x17E695CA08DaBa6f9b351008A2DD9D65cb8F679b",
                    decimals: 18
                },
                {
                    token: "DAI",
